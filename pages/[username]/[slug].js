          ...
          <Grid lg={14}>
            ...
            <Col>
              <Card shadow style={{ width: "100%" }}>
                ...
                <Text p>
                  There are N number of directions to go into when preparing for
                  a technical interview. This guide is a summary of my
                  experience and one single direction that can be taken which
                  will give you results for sure without digressing from your
                  path. It will save you time as you do not have to follow
                  multiple resources online.
                </Text>
                <Text p>
                  I have prepared a checklist of things from my personal
                  experience while preparing for companies like Uber, Google,
                  Flipkart, Amazon, Microsoft & Facebook. I gave about 2 hours
                  everyday for a period of 2 months for the preparation and this
                  is the summary.
                </Text>
                <Spacer y={1.5} />
                <Divider />
                ...
                <Row>
                  <Avatar
                    src={"https://i.loli.net/2021/03/07/uAfLay5rhPlskK9.png"}
                    size="medium"
                  />
                  <Spacer x={0.5} />
                  <Card style={{ width: "90%" }}>
                    ...
                    <Text p>
                      Yesterday was stuck with back tracking question, this
                      really helped a lot. Since having a step by step approach
                      helps in breaking down the problem statement in smaller
                      unit, solving becomes easier.
                    </Text>
                    <Text p />
                    <Text p>
          ...
          <Grid lg={6}>
            ...
            <Col>
              <Card shadow style={{ width: "90%" }}>
                <Row align={"middle"}>
                  <Avatar
                    src={"https://i.loli.net/2021/03/07/O154GQiXntzVA8k.png"}
                    size="medium"
                  />
                  <Spacer x={0.5} />
                  <Text b size={20}>
