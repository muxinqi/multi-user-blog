import { Button, Input, Link, Row, Spacer, Text } from "@geist-ui/react";
    ...
    return (
      <>
        ...
        <Button auto type="success-light" style={{ width: "100%" }}>
          <Text b>Continue</Text>
        </Button>
        <Spacer y={1.5} />
        <Row justify={"center"}>
          <Link color href={"/users/password/new"}>
            <Text small>I forgot my password</Text>
          </Link>
        </Row>
      </>
    );
